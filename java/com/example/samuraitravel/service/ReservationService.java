...
public class ReservationService {
	...
	public boolean isWhithinCapacity(Integer numberOfPeople, Integer capacity) {
		return numberOfPeople <= capacity;
	}

	//宿泊料金を計算する
	public Integer calculateAmount(LocalDate chackinDate, LocalDate chackoutDate, Integer price) {
		long numberOfNights = ChronoUnit.DAYS.between(chackinDate, chackoutDate);
